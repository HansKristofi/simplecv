...
<script>
  (function(){
    ...
    function ensureAccentStyles(){
      ...
      /* headings and key title classes inside accent areas should be white for contrast */\\
      ...
      .accent-applied h1, .accent-applied h2, .accent-applied h3, .accent-applied h4, .accent-applied h5, .accent-applied h6,\\
      .has-accent .name, .accent-applied .name, .has-accent .title, .accent-applied .title, .has-accent .summary, .accent-applied .summary { color: #ffffff !important; }\\
      ";
